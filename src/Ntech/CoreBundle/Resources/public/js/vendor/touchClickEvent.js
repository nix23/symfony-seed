NtechApp.TouchClickEvent = function() {
    var me = this;
...
NtechApp.TouchClickEvent.TOUCH_CLICK_EVENT_DATA_UID_DATA_ATTR = "data-ntechapp-touchclick-data-uid";
NtechApp.TouchClickEvent.RECOGNIZE_AS_SCROLL_PX_DISTANCE = 5;
NtechApp.TouchClickEvent.DELETE_TOUCH_DATA_AFTER_MS_COUNT = 300;

NtechApp.TouchClickEvent.prototype.listen = function($element, maybeListenElementChild, callbackFn) {
    var me = this;
    ...
    $element.on("touchend", $elementChild, function(event) {
        ...
        var touchData = me._getTouchData(DomElem);
        // We also have an option to supress events without touchstart(touchData == null)
...
NtechApp.TouchClickEvent.prototype._hasTouchData = function(DomElem) {
    var attr = NtechApp.TouchClickEvent.TOUCH_CLICK_EVENT_DATA_UID_DATA_ATTR;
...
NtechApp.TouchClickEvent.prototype._getTouchData = function(DomElem) {
    var attr = NtechApp.TouchClickEvent.TOUCH_CLICK_EVENT_DATA_UID_DATA_ATTR;
...
NtechApp.TouchClickEvent.prototype._addTouchData = function(DomElem) {
    var attr = NtechApp.TouchClickEvent.TOUCH_CLICK_EVENT_DATA_UID_DATA_ATTR;
...
NtechApp.TouchClickEvent.prototype._removeTouchData = function(DomElem) {
    var attr = NtechApp.TouchClickEvent.TOUCH_CLICK_EVENT_DATA_UID_DATA_ATTR;
    var touchDataUID = DomElem.getAttribute(attr);
...
NtechApp.TouchClickEvent.prototype._clearOutdatedTouchData = function() {
    var currentTime = (new Date).getTime();
    var deleteAfterMsCount = NtechApp.TouchClickEvent.DELETE_TOUCH_DATA_AFTER_MS_COUNT;

    for(var i = 0; i < this._touchData.length; i++) {
        if(currentTime - this._touchData[i].startTime > deleteAfterMsCount) {
            var uidAttr = NtechApp.TouchClickEvent.TOUCH_CLICK_EVENT_DATA_UID_DATA_ATTR;
...
NtechApp.TouchClickEvent.prototype._saveTouchStartCoords = function(event, touchData) {
...
NtechApp.TouchClickEvent.prototype._isNativeTouchScroll = function(event, touchData) {
    var validDistance = NtechApp.TouchClickEvent.RECOGNIZE_AS_SCROLL_PX_DISTANCE;
